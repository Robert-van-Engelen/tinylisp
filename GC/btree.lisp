...
;
; IMPORTANT: this example requires garbage collection to retain global tree data, otherwise
; globally-defined trees will be corrupted when returning to the REPL with the trivial gc()
