/* tinylisp-float.c with single float precision NaN boxing by Robert A. van Engelen 2022 */
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#define I unsigned
...
L f_int(L t,L e) { L n = car(evlis(t,e)); return n<1e7 && n>-1e7 ? (long long)n : n; }
...
L atomic() { L n; I i; return sscanf(buf,"%g%n",&n,&i) > 0 && !buf[i] ? n : atom(buf); }
